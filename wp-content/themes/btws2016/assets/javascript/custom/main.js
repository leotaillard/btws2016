...
(function() {
    ...
    jQuery(".landing-page").click(function() {
        jQuery(".landing-page").animate({
            "opacity": 0
        }, 400, function() {
            jQuery(".landing-page").remove();
        })
    });
	
	var page = jQuery('html, body');
	jQuery(".btws-the-visit #guided-tour").click(function(){
		page.on("scroll mousedown wheel DOMMouseScroll mousewheel keyup touchmove", function(){
			page.stop();
		});
		page.animate({ scrollTop: jQuery(document).height() }, 10000, function(){

...
<html lang="fr">
	...
	<script src="<?php echo bloginfo('template_url'); ?>/js/modernizr.custom.js"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/js/classie.js" type="text/javascript"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/js/jquery.isotope.min.js" type="text/javascript"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/js/elevator.min.js" type="text/javascript"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/js/jquery.bigtext.js" type="text/javascript"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/js/jquery.fittext.js" type="text/javascript"></script>
    <script src="<?php echo bloginfo('template_url'); ?>/js/main.js" type="text/javascript"></script>

	<link rel="shortcut icon" href="<?php echo bloginfo('template_url'); ?>/ico/favicon.png">
	<?php if (is_front_page()) { ?><link rel="shortcut icon" href="<?php echo bloginfo('template_url'); ?>/ico/favicon.png"><?php } ?>
	<?php if (is_page_template( 'template-archives-journal.php' ) || is_home() || is_singular('post')) { ?><link rel="shortcut icon" href="<?php echo bloginfo('template_url'); ?>/ico/gazette-favicon.png"><?php } ?>
	<?php if (is_page_template( 'template-archive-work.php' ) || is_page_template( 'template-last-work.php' ) || is_singular( 'work' )) { ?><link rel="shortcut icon" href="<?php echo bloginfo('template_url'); ?>/ico/work-favicon.png"><?php } ?>
	<?php if (is_page(7)) { ?><link rel="shortcut icon" href="<?php echo bloginfo('template_url'); ?>/ico/work-favicon.png"><?php } ?>
	<?php if (is_page(30)) { ?><link rel="shortcut icon" href="<?php echo bloginfo('template_url'); ?>/ico/gazette-favicon.png"><?php } ?>
